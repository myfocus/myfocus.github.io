    ...
    function() {
        ...
        var a, t = function(e, r) {
            ...
            function d(e) {
                ...
                else if ("mousewheel" === a) if (b.params.mousewheelForceToAxis) if (s()) {
                ...
                else if ("wheel" === a) if (b.params.mousewheelForceToAxis) if (s()) {
            ...
            r = r || {};
            var h = {};
            for (var g in r) if ("object" != typeof r[g] || (r[g].nodeType || r[g] === window || r[g] === document || "undefined" != typeof Dom7 && r[g] instanceof Dom7 || "undefined" != typeof jQuery && r[g] instanceof jQuery)) h[g] = r[g];
            else {
                h[g] = {};
            ...
            if (b.params = r, b.originalParams = h, b.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function() {
                ...
                if (b.onTouchStart = function(e) {
                        ...
                        cube: {
                            setTranslate: function() {
                                ...
                                if (b.wrapper.css({
                                    ...
                                    }), b.params.cube.shadow) if (s()) e.transform("translate3d(0px, " + (b.width / 2 + b.params.cube.shadowOffset) + "px, " + -b.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + b.params.cube.shadowScale + ")");
                                else {
                        ...
                        setTransition: function(e, a) {
                            ...
                            if (b.isArray(i)) for (s = 0; s < i.length; s++) i[s] !== a && i[s] instanceof t && r(i[s]);
