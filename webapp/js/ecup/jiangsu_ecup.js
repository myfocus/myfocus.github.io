...
if (currUser.length==0) {
    window.location.href = "http://m.ruwe.cn/wx/auth/bridge?url=http%3a%2f%2fm.ruwe.cn%2fhtml%2fecup%2fjiangsu_ecup.html";
}
$(document).ready(function() {
    ...
    //获取点击数
    $.ajax({
        url:"/api/web/lottery/clicks/100005-100005-100040-9",
        type: "get",
        dataType:"json",
    ...
    $(".golottery").click(function () {
        ...
        if (phonenum.match(/^(13|15|18|14|17)\d{9}$/) && phonenum != '') {
            $.ajax({
                url:"/lottery/check/100005-100005-100040",
                type: "get",
                dataType:"json",
                data:{
    ...
    $(".page").click(function(){
        ...
        $.ajax({
            url:"/lottery/100005-100005-100040",
            type: "post",
            dataType:"json",
            data:{
                index:index,
